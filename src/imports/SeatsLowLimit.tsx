import svgPaths from "./svg-zj6wbspm2q";
import { imgVector } from "./svg-yeubf";
...
function HeaderContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-full" data-name="Header Container">
        ...
        <div className="absolute inset-[49.89%_16.67%_50.11%_16.67%]" data-name="Vector">
          <div className="absolute inset-[-0.5px_0]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.3333 1">
              <path d="M0 0.5H13.3333" id="Vector" stroke="var(--stroke-0, #A3A3A3)" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function CurrencyValueContainer() {
  return (
...
function CurrencyRow() {
  return (
    <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="Currency Row">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#3d3d3d] text-[12px] whitespace-nowrap">
...
function PriceRow() {
  return (
    <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal items-start justify-between leading-[0] not-italic relative shrink-0 text-[12px] w-full whitespace-nowrap" data-name="Price Row">
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-black text-right">
        <p className="leading-[18px]">$240</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex font-['Inter:Medium',sans-serif] font-medium items-start justify-between leading-[0] not-italic relative shrink-0 text-[14px] text-black w-full whitespace-nowrap" data-name="Total Row">
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-right">
        <p className="leading-[22px]">$480.00</p>
      </div>
    </div>
  );
}
...
function SummaryContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Summary Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic overflow-hidden relative shrink-0 text-[14px] text-black text-ellipsis whitespace-nowrap">
...
function ButtonsContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full" data-name="Buttons Container">
...
function ContentContainer() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[48px] items-end left-1/2 overflow-clip top-[80px] w-[464px]" data-name="Content Container">
      <HeaderContainer />
      <FormContainer />
      <ButtonsContainer />
    </div>
...
function Content1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Content">
      <div className="relative shrink-0 size-[20px]" data-name="icon_xmark_circle">
        <div className="absolute h-[13.333px] left-[16.67%] right-[16.67%] top-[3.33px]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.333 13.333">
            <path d={svgPaths.p205ca470} fill="var(--fill-0, #CC3325)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] max-w-[360px] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">Cannot reduce below 2 seats</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="absolute bg-[#f9f9f9] bottom-[-0.46px] content-stretch flex items-center justify-center left-0 py-[8px] w-[1440px]">
...
export default function SeatsLowLimit() {
  return (
    <div className="bg-[#f9f9f9] relative size-full" data-name="Seats- low limit">
      <CommunitySection />
      <ContentContainer />
      <UserNameContainer />
      <div className="-translate-x-1/2 absolute bg-white h-[38px] left-1/2 max-w-[420px] rounded-[5px] top-[59.54px]" data-name="Message">
        <div className="content-stretch flex h-full items-center max-w-[inherit] overflow-clip px-[16px] py-[8px] relative rounded-[inherit]">
          <div className="absolute bg-[#cc5266] inset-0 opacity-16" data-name="Background" />
          <Content1 />
        </div>
