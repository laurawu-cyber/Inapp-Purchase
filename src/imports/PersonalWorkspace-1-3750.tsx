...
function NavigationSidebar() {
  return (
    <div className="absolute bg-[#f9f9f9] content-stretch flex flex-col h-[900px] items-start left-0 overflow-clip top-0 w-[220px]" data-name="Navigation Sidebar">
      <UserInfo />
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-[952px]">
...
function Frame38() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] items-start left-[366px] top-[830px]">
      <Frame30 />
      <Frame12 />
    </div>
  );
...
function Frame36() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16px] items-end left-[326px] top-[50px] w-[992px]">
      <Frame37 />
      <Frame35 />
    </div>
  );
...
function Frame55() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[315px] items-start left-[366px] top-[481px] w-[952px]">
      <Frame21 />
      <Frame22 />
    </div>
  );
...
function DropMenu() {
  return (
    <div className="absolute bg-white content-stretch flex items-center left-[16px] overflow-clip py-[8px] rounded-[5px] shadow-[0px_0px_32px_0px_rgba(0,0,0,0.1)] top-[106px] w-[260px]" data-name="drop_menu">
      <Frame86 />
    </div>
  );
}
...
export default function PersonalWorkspace() {
  return (
    <div className="bg-white relative size-full" data-name="Personal workspace">
      <NavigationSidebar />
      <Frame38 />
      <Frame36 />
      <Frame55 />
