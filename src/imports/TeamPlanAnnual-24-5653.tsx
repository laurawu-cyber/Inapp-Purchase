...
function Toggle({ className, disabled = false, state = true }: ToggleProps) {
  return (
    <div className={className || `h-[20px] overflow-clip relative rounded-[5px] w-[36px] ${!state && disabled ? "bg-[#d6d6d6] opacity-60" : !state && !disabled ? "bg-[#d6d6d6]" : state && disabled ? "bg-black opacity-60" : "bg-black"}`}>
      <div className={`-translate-y-1/2 absolute bg-white rounded-[3px] size-[16px] top-1/2 ${!state ? "left-[2px]" : "right-[2px]"}`} data-name="Knob" />
    </div>
  );
}
...
function ListChevron({ className, status = "Active", type = "Down" }: ListChevronProps) {
  ...
  return (
    <div className={className || `overflow-clip relative rounded-[5px] size-[20px] ${type === "Up" && status === "Active" ? "bg-[#ebebeb]" : ""}`}>
      <div className={`-translate-x-1/2 -translate-y-1/2 absolute h-[4px] left-1/2 top-1/2 w-[8px] ${isUp ? "flex items-center justify-center" : ""}`}>
        <div className={isUp ? "-scale-y-100 flex-none" : "absolute inset-[-8.84%_-4.42%_-17.68%_-4.42%]"}>
          {type === "Down" && (
...
export default function TeamPlanAnnual({ className }: { className?: string }) {
  return (
    <div className={className || "h-[1070px] relative w-[1440px]"} data-name="Team Plan-annual">
      ...
      <div className="absolute bg-[#f9f9f9] h-[1099px] left-0 overflow-clip rounded-[5px] top-0 w-[1440px]" data-name="Main Container">
        <div className="absolute content-stretch flex items-center left-[1396px] p-[4px] top-[16px]" data-name="Close Button Container">
          <div className="flex items-center justify-center relative shrink-0">
            <div className="-scale-y-100 flex-none rotate-180">
        ...
        <div className="absolute content-stretch flex flex-col items-center left-[243.5px] top-0 w-[953px]">
          <div className="content-stretch flex flex-col items-center relative shrink-0 w-full">
            <div className="content-stretch flex flex-col gap-[16px] items-center py-[56px] relative shrink-0 w-full" data-name="Header Container">
              ...
              <div className="content-stretch flex gap-[12px] items-center justify-center pb-[24px] pt-[16px] relative shrink-0 w-full" data-name="billed">
                <Toggle className="bg-black h-[20px] overflow-clip relative rounded-[5px] shrink-0 w-[36px]" />
                    ...
                    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="price & button">
                      <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
                        <div className="content-stretch flex gap-[4px] items-end relative shrink-0 w-full" data-name="Pricing">
                          <p className="font-['Inter:Light',sans-serif] font-light leading-[44px] not-italic relative shrink-0 text-[32px] text-black whitespace-nowrap">$20</p>
                        ...
                        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] not-italic relative shrink-0 text-[#3d3d3d] text-[14px] whitespace-nowrap">Billed annually ($240 per seat)</p>
                      </div>
                      <div className="content-stretch flex flex-col items-start relative shrink-0">
                        <AnnualPlanButton />
                      </div>
